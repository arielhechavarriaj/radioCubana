...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-800 py-4 mt-8 border-t dark:border-gray-700">
      <div className="container mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600 dark:text-gray-400">
        <p>© {new Date().getFullYear()} RadioCubana. Creado con ❤️ por LeiraStudio.</p>
        <div className="flex space-x-4 mt-2 sm:mt-0">
          ...
          <a
            href="https://twitter.com/tuhandle"
            target="_blank"
            rel="noopener noreferrer"
